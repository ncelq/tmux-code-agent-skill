...
```
dispatch.cmd Cursor "/requesting-code-review for <FEATURE_NAME> | TODO: 1) Review feature; follow receiving-code-review skill. 2) dispatch.cmd orchestrator \"STATUS UPDATE - code review finished, status: STATUS, summary: SUMMARY\" — STATUS=pass or issues, SUMMARY=review result or issue list. | AVOID: - DO NOT implement fixes - DO NOT skip TODO 2 - DO NOT stop before TODO 2 succeeds"
```
